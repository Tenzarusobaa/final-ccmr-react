// src/pages/AdminVIEW/AdminINFDashboard.js
...
const AdminINFDashboard = ({ userData, onLogout, onNavItemClick, onExitViewAs }) => {
  ...
  // Use INF styling for admin INF dashboard
  const getOfficeClass = () => "office-records-inf";
  ...
  // Define tabs and components for Admin INF Dashboard
  const getTabsConfig = () => {
    return {
      tabs: [
        "Medical Records (INF)",
              ...
              <div className="date-guide-container">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <div className="admin-view-indicator">
                    <span className="admin-badge">Admin View - INF Office</span>
                  </div>
                  <AddButton
          ...
          <div className="dashboard-right">
            ...
            <div className="sidebar-card">
              ...
              <div className="admin-info">
                ...
                <p><strong>Office:</strong> INF (Infirmary)</p>
...
export default AdminINFDashboard;