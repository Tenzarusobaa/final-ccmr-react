...
const DashboardNavigation = ({ userDepartment, userType, userName, onLogout, onExitViewAs }) => {
    ...
    // Define office configurations for Administrator - IMPORTANT: Keep the same as NavBar.js
    ...
    // Define navigation items and their routes based on user type - IMPORTANT: Match NavBar.js
    const getNavRoutes = () => {
    ...
    return (
        <>
            <header className={`dashboard-header ${isViewingAsOffice ? `department-${viewAs.toLowerCase()}` : `department-${type.toLowerCase()}`}`}>
                {/* === Top Row === */}
                <div className="header-top">
                    ...
                    <div className="nav-logo">
                        ...
                        <div className="logo-text-container">
                            ...
                            <div className="logo-department-text">
                                {isViewingAsOffice
                        ...
                        {type === "Administrator" ? (
                            ...
                            <>
                                {isViewingAsOffice ? (
                                    ...
                                    <>
                                        <div
                                            className="nav-item view-as-indicator"
                                            style={{
                                    ...
                                    <>
                                        <div
                                            className={`nav-item ${isActive("Administrator Dashboard") ? 'active' : ''}`}
