// OPDPsychologicalRecordsINF.js - Updated with admin styling support
import React, { useState, useEffect } from 'react';
import './DashboardTables.css';

const OPDPsychologicalRecordsINF = ({ userType = 'default', onRowClick, isAdmin = false }) => {
    ...
    return (
        <div className={getContainerClass()}>
            <h3 className={getHeaderClass()}>Psychological Records (INF) - Recent 10</h3>
